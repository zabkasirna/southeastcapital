...
GLOBAL:
        ...
        ✓ Main Header > faux-bg > remove @abp @done (15-08-14 12:05)
        ✓ Main Nav > add active state based on current visible section @beyond-cbp @done (15-08-10 11:08)
        ✓ Main Nav > add active state on hover @beyond-cbp @done (15-08-14 12:03)
...
SECTION:
    □ /CONCEPT
        ✓ Body > text > change alignment to center @beyond-l @done (15-08-14 11:31)
    ...
    □ /EXCITEMENT
        ...
        ✓ Body > image > switch colored/greyscaled on hover in/out @abp @done (15-08-14 15:51)
        □ /SINGLE-EXCITEMENT
